# -*- coding: utf-8 -*-
"""
Created on Sat Feb 20 10:46:31 2021
...
from layers import Affine, Sigmoid, Relu, SoftmaxWithLoss, BatchNormalization, Dropout
    ...
    def __init_weight(self, weight_init_std):
        ...
        for idx in range(1, len(all_size_list)):
            ...
            if str(weight_init_std).lower() in ('relu', 'he'):
                ...
                scale = np.sqrt(1.0 / all_size_list[idx - 1])  # Sigmoid使用的随机化标准差
